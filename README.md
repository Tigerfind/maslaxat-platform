...
- двухэтапные возвраты и контролируемые выплаты (`docs/FINANCE_WORKFLOWS.md`)
...
`RUN_SEED=1` добавляет только справочники и промокоды. Demo-аккаунты создаются
только при `ALLOW_PRODUCTION_DEMO_DATA=1` и наличии трёх отдельных `DEMO_*_PASSWORD`.
