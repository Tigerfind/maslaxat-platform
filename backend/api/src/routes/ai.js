...
Наши юристы по гражданскому праву помогут составить претензию.`,
  ...
  return {
    reply: `Благодарю за ваш вопрос. Я — AI юридический консультант платформы MaslaXat, специализирующийся на **законодательстве Республики Узбекистан**.

Я могу помочь с вопросами по:
• **Трудовому праву** — увольнение, зарплата, трудовые споры
• **Семейному праву** — развод, алименты, опека
• **Коммерческому праву** — регистрация бизнеса, ООО, лицензии
• **Земельному праву** — недвижимость, аренда, купля-продажа
• **Налоговому праву** — НДС, НДФЛ, декларации
• **Уголовному праву** — права обвиняемого, задержание
• **Защите прав потребителей** — возврат товара, гарантия

Опишите вашу ситуацию подробнее — я дам ответ со ссылками на конкретные статьи законов.`,
    category: null,
  };
};
